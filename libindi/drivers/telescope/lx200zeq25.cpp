...
//20200415 zy 用lx200的不对，马来西亚用户" 祥泉珍藏"测试ok
...
/*    switch (controller_format)
    ...
    return (setZEQ25StandardProcedure(fd, read_buffer));
...
bool LX200ZEQ25::Park()
{
    ...
    if (setZEQ25ObjectRA(PortFD, equatorialPos.ra) < 0 || (setZEQ25ObjectDEC(PortFD, equatorialPos.dec)) < 0)
    {
