...
/*
	20200311 chen反馈说Sd错误
	 there is a similar extra space in the :Sd command, but the Sd command is worse.  Sd command is defined by Meade as:
	But ASIAIR is sending it with colon separator between DD and MM, instead of *, like 。。。
...
/*
20200311 chen
For your information, SkySafari on MacOS X sends the following
 
:Sg343*46# for Longitude 16o 13' 52" EAST (Baden, Austria), and
 
:Sg122*41# for Longitude 122o 40' 35" WEST (Portland, Oregon, USA).
-------------------------------------------
